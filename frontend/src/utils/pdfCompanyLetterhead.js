...
export const LETTERHEAD_COMPANY_NAME_FONT_SIZE = 23;
export const LETTERHEAD_ADDRESS_FONT_SIZE = 11;
export const LETTERHEAD_CONTACT_FONT_SIZE = 11;
export const LETTERHEAD_MIDDLE_BLOCK_HEIGHT = 14;
export const LETTERHEAD_REPORT_TITLE_FONT_SIZE = 16;
...
/**
 * Standard YORA company letterhead for A4 PDFs.
...
export function drawCompanyLetterhead(doc, company) {
  ...
  const startY = blockTop + (LETTERHEAD_MIDDLE_BLOCK_HEIGHT - contentHeight) / 2 + 3.5;
  ...
  y = addSeparatorLine(doc, pageWidth, y, margin, 5);
  y = addCenteredContactLine(doc, pageWidth, y, company?.phone, company?.email);
